...
if not exist "LibreOfficeSetup.msi" (
    echo Baixando instalador oficial do LibreOffice do site...
    powershell -Command "$wc = New-Object System.Net.WebClient; $wc.DownloadFile('https://www.libreoffice.org/donate/dl/win-x86_64/7.6.4/en-US/LibreOffice_7.6.4_Win_x64.msi', 'LibreOfficeSetup.msi')"
)
